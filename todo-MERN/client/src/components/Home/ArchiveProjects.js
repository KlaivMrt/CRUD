...
const ArchiveProjects = () => {
    const {deleteProject, showProject, setProject, handlePopup, archiveProjects, setStatus, completeProject} = useContext(Context)
    ...
    return(
        <div className={"row active-projects h-75"}>
            <div className={"d-flex flex-row justify-content-around align-items-center"}>
                <i id={"archive"} className={"bi bi-caret-down-square-fill h2"} onClick={() => navigate("/home/active")}>
                </i>

                <h3 className={"my-1"}>Archived Projects</h3>
